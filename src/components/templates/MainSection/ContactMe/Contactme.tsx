...
const ContactMe = () => {
  ...
  return (
    <section className={`relative z-20 w-full h-[80vh] flex ${locale === 'fa' ? '' : 'flex-row-reverse'} items-center justify-center gap-8`}>
      <article className="w-1/2 h-full flex flex-col items-center justify-between space-y-10">
      ...
      <div className="w-1/2 h-full flex flex-col items-center justify-between space-y-4">
