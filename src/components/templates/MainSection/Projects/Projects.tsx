        ...
        return (
          ...
          >
            <div className="w-1/2 h-full flex items-center justify-center">
              <div className="bg-[url('/images/card.png')] bg-contain bg-center bg-no-repeat h-[420px] 3xl:h-[520px] w-[380px] 3xl:w-[450px] relative">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-10/12 flex flex-col items-center justify-center gap-5 3xl:gap-6 py-8 px-6">
                  ...
                  <div className="flex items-center justify-center gap-2 w-3/4 group hover:gap-4 duration-300">
                    <Button disabled={!project.link} className="bg-background w-full shadow-none hover:bg-background/80 group-hover:bg-background/80 text-base">
