...
export default function Contact() {
  ...
  return (
    <section className="w-full flex flex-col items-center justify-around z-50">
      <div className="flex flex-col gap-10 items-center justify-center">
        <div className="w-full h-full flex items-center justify-center">
          <h2 className="lg:text-5xl text-4xl text-secondary">{t('contactme')}</h2>
        </div>
        <div className="w-full h-full flex flex-col items-center justify-around gap-5">
          <p className="text-xl text-secondary/80 text-center">{t('contactone')}</p>
          <p className="text-xl text-secondary/80 text-center">{t('contacttwo')}</p>
          ...
          <ul className="flex flex-wrap lg:flex-row flex-col w-full lg:w-auto items-center justify-center lg:gap-6 gap-2">
            <li className='w-full lg:w-auto'>
              <Link href="tel:+989169799533" target="_blank" className="flex items-center gap-2 xl:text-2xl justify-center p-4 bg-linear bg-linear-180 from-foreground/20 to-background shadow-lg rounded-xl group hover:from-foreground text-secondary duration-300 transition-colors cursor-pointer">
                <span>{t('phone')}</span>
                <IoCall />
              </Link>
            </li>
      ...
      <p className="opacity-50 text-secondary mt-12 text-center">{t('rights')}</p>
    </section>
  );
}
